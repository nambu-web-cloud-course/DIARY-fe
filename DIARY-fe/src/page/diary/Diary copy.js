              ...
              <div className="box-diary" key={myDiary.id}>
                ...
                >
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{ __html: myDiary?.diary_content }}
                  />
                </div>
              </div>
            ))
          ) : (
            <div className="no-diary-message">작성된 일기가 없습니다.</div>
          )}
        </div>
